            ...
            <ul class="nav">
                <li class="active ">
                    <a href="./dashboard.html">
                        ...
                        <p><a href="etudiant.php?infos" style="color: red;">mes informations</a></p>
                    </a>
                </li>
                ...
                <li class="active ">
                    <a href="./dashboard.html">
                        <i class="nc-icon nc-bank"></i>
                        <p><a href="etudiant.php?message" style="color: red;">message</a></p>
                    </a>
                </li>
            </ul>
        </div>
                                    ...
                                    <div class="numbers">
                                        <a class="navbar-brand">
                                            ...
                                            if ($_SESSION['etudiant']->genre == "homme") {
                                                echo "Salut Monsieur " . strtoupper($_SESSION['etudiant']->prenom . ' ' . $_SESSION['etudiant']->nom);
                                            } else {
                                                echo "Salut Madame " . strtoupper($_SESSION['etudiant']->prenom . ' ' . $_SESSION['etudiant']->nom);
                                            }
