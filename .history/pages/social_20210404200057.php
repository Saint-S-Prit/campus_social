            ...
            <ul class="nav">
                ...
                <li>
                    <a href="social.php?p=add">
                        <i style='color:red' class="fa fa-user-plus"></i>
                ...
                <li>
                    <a href="social.php?p=recherche-codifier">
        ...
        <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navigation">
                    <a href="social.php?p=message">Messages <i class="nc-icon nc-email-85"></i><span style="color: #f04323;font-weight:bold; margin-right:30px;"><span style="padding-right: 3px;"><?= count(findNoLu()); ?></span></span></a>
                    ...
                    <div class="card card-stats">
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="col-7 col-md-8">
                                    <div class="numbers">
                                        <p class="card-category">etudiants codifier</p>
                                        <?= count(codification($codifier = "oui")) ?>
                                        <p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 col-md-8">
                                    <div class="numbers">
                                        ...
                                        <?= count(codification($codifier = "non")) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-8" style="margin: 0 auto;">
                                    ...
                                    if (isset($_GET['p'])) {
                                        ...
                                        switch ($p) {
                                            ...
                                            case 'recherche-codifier':
                                                require_once('user/listeEtudiantCodifier.php');
                                                break;
                                            case 'recherche':
                                                require_once('user/listeEtudiantCodifier.php');
                                                break;
                                            case 'edite':
                                                ...
                                                break;
                                            case 'codifier':
                                                require_once('user/codifierByAgent.php');
                                                break;
                                            case 'message':
