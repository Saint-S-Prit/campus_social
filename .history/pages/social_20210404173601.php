...
include('../top-bar.php');
include('../head.php');
require('inclures/header.php');
require('../modeles/message.php');
?>
        ...
        <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navigation">
                    <a href="social.php?p=message">Messages <i class="nc-icon nc-email-85"></i><span style="color: #f04323;font-weight:bold; margin-right:30px"><?= count($nbr_message_non_lu); ?></span></a>
