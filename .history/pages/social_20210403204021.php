            ...
            <ul class="nav">
                ...
                <li>
                    <a href="social.php?p=message">
                        ...
                        <p>Messages <span style="color: #f04323;font-weight:bold"><?= count($nbr_message_non_lu); ?></span></p>
                    </a>
                </li>
