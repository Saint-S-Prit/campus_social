...
if (isset($_GET['p']) == "condifier") {
    ...
    // $etudiants = codificationItem($recherche);
    // var_dump($etudiants);
}
?>
<!-- PROFILE DETAIL -->
            ...
            <div class="profile-detail">
                <div class="profile-info">
                    ...
                    <form action="" method="GET">
                        <input type="hidden" name="p" value="recherche" class="form-control">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <a href="social.php"><button class="btn btn-primary" class="form-control" style="margin-top: 1px;">recherche</button></a>
                                </div>
                            </div>
