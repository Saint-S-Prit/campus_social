                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <a href="social.php?p=list&detele=<?= $etudiant->id; ?>">
                                                ...
                                                ?>
                                                    <a href="social.php?p=delete&etudiant_id=<?= $etudiant->id; ?>"><i class="fa fa-user" aria-hidden="true"></i></a>
                                                <?php
                                                } elseif (isset($etudiant->archive) && $etudiant->archive == 0) {
                                                ?>
                                                    <a href="social.php?p=delete&etudiant_id=<?= $etudiant->id; ?>"><i style="color: red;" class="fa fa-lock" aria-hidden="true"></i></a>
