                    ...
                    <tbody>
                        ...
                        ?>
                                <tr style="text-align: center;">
                                    ...
                                    ?>
                                        <td>
                                            <a href="social.php?p=list&detele=<?= $etudiant->id; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                        </td>
                                        <td>
                                            <!-- Button trigger modal -->
                                            <a href="social.php?p=edite&idEtudiant=<?= $etudiant->id; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                        </td>
                                        <td>
