                                    ...
                                    ?>
                                        <td>
                                            <a href="social.php?p=list&detele=<?= $etudiant->id; ?>">
                                                ...
                                                ?>
                                                    <a href="social.php?p=codifier&etudiant_id=<?= $etudiant->id; ?>"><i class="nc-single-02" aria-hidden="true"></i></a>
                                                <?php
                                        ...
                                        <td>
                                            <a href="social.php?p=codifier&etudiant_id=<?= $etudiant->id; ?>"><i class="fa fa-lock" aria-hidden="true"></i></a>
                                        </td>
                                    <?php
