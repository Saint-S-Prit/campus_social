...
<form method="POST">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="formGroupExampleInput" placeholder=" votre email" name="email">
    </div>
    <div class="form-group">
        <label for="formGroupExampleInput">Message</label>
        <textarea name="message" id="" cols="30" rows="10" placeholder="ecrire votre message"></textarea>
    </div>
