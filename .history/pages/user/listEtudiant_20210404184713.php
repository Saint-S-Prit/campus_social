                                ...
                                <tr>
                                    ...
                                    ?>
                                        ...
                                        <td style="text-align: center; color:orangered">
                                            <a style="color:orangered" href="social.php?p=edite&idEtudiant=<?= $etudiant->id; ?>"><i class="fa fa-edit"></i></a>
                                        </td>
                                        <td style="text-align: center;">
                                            <a href="social.php?p=edite&idEtudiant=<?= $etudiant->id; ?>"> <i class="fa fa-bed" aria-hidden="true"></i></a>
                                        </td>
