...
foreach ($tab as $collection) {
    ...
    $tabEtudiant = json_decode(json_encode($infoEtudiant)[0], true);
    var_dump($tabEtudiant);
?>
    <main role="main" class="container">
        <h3 class="mt-5"><?php echo $collection['email']; ?></h3>
        <p class="lead"><?php echo $collection['contenu']; ?></p>
        <p>Envoyer <a href="../sticky-footer-navbar/">the sticky footer with a fixed navbar</a> par <?php echo $tabEtudiant->prenom; ?></p>
    </main>
<?php
}
