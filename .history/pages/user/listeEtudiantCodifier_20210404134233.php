                ...
                <div class="profile-info">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="text" name="reche" class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <a href="social.php?p=recherche"><button class="btn btn-primary" class="form-control" style="margin-top: 1px;">recherche</button></a>
                                </div>
                            </div>
