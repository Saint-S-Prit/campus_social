...
if (isset($_GET['p'])) {
    ...
    $etudiant = codificationItem($_POST['p']);
    $effetctif = count($etudiants);
}
?>
<!-- PROFILE DETAIL -->
                    ...
                    <form action="" method="get">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <button class="btn btn-primary" class="form-control" style="margin-top: 1px;"><a href="social.php?p=recherche"></a>Recherche</button>
                                </div>
                            </div>
