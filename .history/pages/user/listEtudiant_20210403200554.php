                                    ...
                                    ?>
                                        <td>
                                            <a href="social.php?p=list&detele=<?= $etudiant->id; ?>">
                                                <?php
                                                if (isset($etudiant->archive)) {
                                                    echo '                                            <a href="social.php?p=codifier&etudiant_id=<?= $etudiant->id; ?>"><i class="fa fa-bed" aria-hidden="true"></i></a>
                                                    ';
                                                } else {
                                                ?>
                                                    <i class="ni lock-circle-open"></i>
                                                <?php
                                                }
                                                ?>
                                            </a>
