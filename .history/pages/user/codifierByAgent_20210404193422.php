        ...
        if (!empty($ufr) && !empty($genre)) {
            ...
            if (($site == 1 && (($genre == "homme" && $effectif > 14) || ($genre == "femme" && $effectif > 6))) || ($site == 2 && $effectif > 2)) {
                ...
                if (!$req->execute()) {
                    ...
                    $valide = "<div class='col-md-12 card card-stats' style='border-bottom: 1px solid aqua;border-left: 1px solid aqua;'>
                        <div class='profile-detail'>
                            <div class='profile-info'>
                                <h4 class='heading'><?= $prenom . ' ' . $nom  ?></h4>
                                <ul class='list-unstyled list-justify'>
                                    <li>Sexe <span><?= $genre ?></span></li>
                                    <li>compte <span><?= $retVal = ($archive == 1) ? $mdp : 'compte bloqué'; ?></span></li>
                                    <li>Email <span><a><?= $email ?></a></span></li>

                                    <div class='row' style='text-align:center'>
                                        <div class="col-8">
                                            <li>Site <span><a><?= strtoupper($site) ?></a></span></li>
                                            <li>Pavillon <span><a><?= strtoupper($pavillon) ?></a></span></li>
                                            <li>Chambre <span><a><?= $chambre ?></a></span></li>
                                        </div>
                                    </div>
                                </ul>
                            </div>
